...
export function AppLayout({ activePage, onNavigate, onNewTask, search, onSearch, user, onLogout, children }: AppLayoutProps) {
  return (
    <div className="min-h-screen bg-banbif-surface text-banbif-text">
      ...
      <div className="min-[769px]:pl-[260px]">
        <Header onNewTask={onNewTask} search={search} onSearch={onSearch} user={user} />
